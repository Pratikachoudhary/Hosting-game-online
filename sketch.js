...
var sword,fruit1,fruit2,fruit3,fruit4,monster,monster2,bonus;
...
function preload() {
  ...
  bonusImage=loadImage("starfruit.jfif");
...
function draw() {
  ...
  gameState=PLAY;
   ...
   if(gameState===END){
     text("press space to serve",250,250);
   }
   ...
   fruit.scale=0.2;
    ...
    r=Math.round(random(1,4)); 
     ...
     if(r == 1) {
      ...
      fruit.addImage(bonus)
     }

     fruit.y=Math.round(random(50,340));
     fruit.velocityX=-(9+2*score/5);
...
function Enemys() {
   ...
   if(World.frameCount%200 === 0) { 
     ...
     monster.velocityX=-(10+2*score/5);
   ...
   if(World.frameCount%200 === 0) {
     ...
     monster2.velocityX=-(10+3*score/5);
